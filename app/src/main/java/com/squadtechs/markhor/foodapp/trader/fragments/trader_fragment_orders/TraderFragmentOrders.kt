...
class TraderFragmentOrders : Fragment() {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.trader_fragment_orders, container, false)
        initViews()
        setUpViewPager()
        return mView
    }
    ...
    private fun setUpViewPager() {
        ...
        val adapter = TraderOrderPagerAdapter(childFragmentManager)
