...
class TraderRegistrationModel(
    ...
    private val companyMobile: String, private val email: String,
    private val password: String, private val confirmPassword: String, private val agreement: Boolean
    ...
    override fun validate(): Boolean = firstName.isNotEmpty() && lastName.isNotEmpty() && mobileNumber.isNotEmpty()
            ...
            && password.equals(confirmPassword) && agreement && android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()
}